...
namespace MPLVS.Folding {
  public class Tag : StructureTag {
    ...
    public override object GetCollapsedHintForm() =>
      ...
      ? Tooltip.FromSpan(this.Snapshot, this.OutliningSpan.Value)
  ...
  public class Tooltip {
    ...
    public static TextBlock FromSpan(ITextSnapshot snapshot, Span span) => FromSnapshot(new SnapshotSpan(snapshot, span));
